...
from lib.keys_wrapper import PrivateKey, PublicKey
...
class Attack(AbstractAttack):
    ...
    def attack(self, publickeys: list[PublicKey], cipher: list[bytes] = [], progress: bool = True) -> tuple[list[PrivateKey] | None, None]:
