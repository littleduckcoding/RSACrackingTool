...
from lib.number_theory import common_modulus_related_message
...
class Attack(AbstractAttack):
    ...
    def common_modulus_related_message_attack(self, c1: bytes, c2: bytes, k1: PublicKey, k2: PublicKey) -> bytes | None:
        if k1.n != k2.n:
            return None
        ...
        decrypted_message = common_modulus_related_message(k1.e, k2.e, k1.n, c1_int, c2_int)
        return long_to_bytes(decrypted_message)

    def attack(self, publickeys: list[PublicKey], cipher: list[bytes] = []):
