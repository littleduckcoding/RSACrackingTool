...
def parse_args():
    ...
    parser.add_argument(
        "-c",
        help="Specify the ciphertext to decrypt. Format : int or 0xhex",
    )
...
def decrypt_file(args, logger):
    ...
    # Check if a private key is provided and there's mething to decrypt
...
def main():
    ...
    if args.c is not None:
        args.c = get_numeric_value(args.c)
